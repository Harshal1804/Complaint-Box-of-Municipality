...
public class MunicipalFirstPage extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_municipal_first_page);
        signup = (Button) findViewById(R.id.signupbtn);
        username1 = (EditText) findViewById(R.id.username1);
        password1 = (EditText) findViewById(R.id.password1);

        db = FirebaseDatabase.getInstance().getReference().child("MunicipalInfo");
        ...
        loginbtn1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (!u.isEmpty() && p.length() > 8 && isValidPassword(p) && !p.isEmpty() && u.matches(pinpattern)) {
                    ...
                    db.child(u).get().addOnCompleteListener(new OnCompleteListener<DataSnapshot>() {
                        ...
                        public void onComplete(@NonNull Task<DataSnapshot> task) {
                            if (!task.isSuccessful()) {
                                ...
                                String authpass = task.getResult().child("cpass").getValue().toString();
                                ...
                                if (p.equals(authpass)) {
                                    Toast.makeText(MunicipalFirstPage.this, "Login successfully", Toast.LENGTH_SHORT).show();
                                    Intent intent = new Intent(MunicipalFirstPage.this, CheckRequestByMunicipal.class);
                                    startActivity(intent);
                                } else {
                                    Toast.makeText(MunicipalFirstPage.this, "Username or password does not match", Toast.LENGTH_SHORT).show();
                                }
                            }
                        }
                    });
                } else {
                    Toast.makeText(MunicipalFirstPage.this, "Please Enter Valid information", Toast.LENGTH_SHORT).show();
                }
        ...
        signup.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(getApplicationContext(), MunicipalSignup.class);
                startActivity(intent);
            }
        });
    }
